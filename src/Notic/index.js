...
export default class Notic {
  ...
  buildMessage(message) {
    ...
    if(message.autoWidth) messageDom.classList.add('notic-message__auto-width');
    ...
    if(this.close.button){
      messageDomInner.classList.add('notic-message-inner__with-button');
      messageDomInnerButton.classList.add('notic-message-close');
